...
func TestShowSnippet(t *testing.T) {
	...
	tests := []struct {
		...
		{"Negative ID", "/snippet/-1", http.StatusBadRequest, nil},
		{"Decimal ID", "/snippet/1.23", http.StatusBadRequest, nil},
		{"String ID", "/snippet/foo", http.StatusBadRequest, nil},
...
func TestSignupUser(t *testing.T) {
	...
	tests := []struct {
		...
		{"Short password", "Bob", "bob@example.com", "pa$$word", csrfToken, http.StatusOK, []byte("This field is too short (minimum is 10 charact")},
